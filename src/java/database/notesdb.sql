...
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('hargun.bajwa.workmail+admin@gmail.com', true, 'Admin','Admin', 'password', 1);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('hargun.bajwa.workmail+anne@gmail.com', true, 'Anne','Annerson', 'password', 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('hargun.bajwa.workmail+barb@gmail.com', true, 'Barb','Barber', 'password', 2);

INSERT INTO `note` (`Title`, `Contents`, `Owner`)
    VALUES ('Quote #1', 'Writing is nature''s way of letting you know how sloppy your thinking is.', 'hargun.bajwa.workmail+anne@gmail.com');
INSERT INTO `note` (`Title`, `Contents`, `Owner`)
    VALUES ('Another quote', '"Java is to JavaScript as ham is to hamster." -  Jeremy Keith', 'hargun.bajwa.workmail+anne@gmail.com');
INSERT INTO `note` (`Title`, `Contents`, `Owner`)
    VALUES ('Barb''s Note', 'Anne should not see this note.', 'hargun.bajwa.workmail+barb@gmail.com');
